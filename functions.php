...
$link = mysqli_connect("hostname", "username", "password", "databse");
...
function displayTweets($type)
{
    ...
    if ($type == 'public') {
        ...
        echo '<p>Mostrando resultados para "' . mysqli_real_escape_string($link, $_GET['q']) . '":</p>';
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        echo "Não existem tweets para serem mostrados.";
    } else {
...
function displaySearch()
{
    ...
    echo '<form class="form-inline">
            ...
            <button type="submit" class="btn btn-primary">Procurar tweets</button>
        </form>';
}
...
function displayTweetBox()
{
    ...
    if ($_SESSION['id'] > 0) {
        ...
        echo '<div id="tweetSuccess" class="alert alert-success">Twitado com sucesso.</div>
